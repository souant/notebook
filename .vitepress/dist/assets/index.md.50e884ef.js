import{_ as s,c as a,o as n,a as l}from"./app.ec6af428.js";const D=JSON.parse('{"title":"Note Book","description":"Note Book","frontmatter":{"lang":"zh-CN","title":"Note Book","description":"Note Book"},"headers":[{"level":2,"title":"使用方式","slug":"使用方式","link":"#使用方式","children":[]}],"relativePath":"index.md"}'),p={name:"index.md"},o=l(`<h1 id="note-book" tabindex="-1">Note Book <a class="header-anchor" href="#note-book" aria-hidden="true">#</a></h1><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#FFCB6B;">└─javascript</span></span>
...
<span class="line"></span></code></pre></div>`,7),e=[o];function t(c,r,i,C,y,A){return n(),a("div",null,e)}const h=s(p,[["render",t]]);export{D as __pageData,h as default};
