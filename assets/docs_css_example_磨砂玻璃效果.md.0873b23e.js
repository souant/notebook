...
<span class="line"><span style="color:#FFCB6B;">backdrop-filter</span><span style="color:#A6ACCD;">: unset;</span></span></code></pre></div><h2 id="兼容性" tabindex="-1">兼容性 <a class="header-anchor" href="#兼容性" aria-label="Permalink to &quot;兼容性&quot;">​</a></h2><p><img src="`+r+'" alt="mdn兼容性"></p>',5),k=JSON.parse('{"title":"磨砂玻璃效果","description":"","frontmatter":{},"headers":[],"relativePath":"docs/css/example/磨砂玻璃效果.md","filePath":"docs/css/example/磨砂玻璃效果.md"}'),b={name:"docs/css/example/磨砂玻璃效果.md"},u=Object.assign(b,{setup(e){return(p,h)=>(a(),n("div",null,[f,A,t(F),B]))}});export{k as __pageData,u as default};
