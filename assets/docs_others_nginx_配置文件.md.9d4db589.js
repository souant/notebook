import{_ as s,o as n,c as a,V as l}from"./chunks/framework.0c5895ca.js";const _=JSON.parse('{"title":"nginx 配置文件","description":"","frontmatter":{},"headers":[],"relativePath":"docs/others/nginx/配置文件.md","filePath":"docs/others/nginx/配置文件.md"}'),p={name:"docs/others/nginx/配置文件.md"},o=l(`<h1 id="nginx-配置文件" tabindex="-1">nginx 配置文件 <a class="header-anchor" href="#nginx-配置文件" aria-label="Permalink to &quot;nginx 配置文件&quot;">​</a></h1><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">#user  nobody;</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div>`,2),e=[o];function t(c,r,i,y,C,A){return n(),a("div",null,e)}const f=s(p,[["render",t]]);export{_ as __pageData,f as default};
